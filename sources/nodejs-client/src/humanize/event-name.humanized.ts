export const EventNamesHumanized: Record<string, string> = {
    ...
    coachingGratuit: 'Coaching Offered',
    paiementEffectue: 'Payment Accepted',
    telechargementBusinessPlanDownload: 'Business Plan Downloaded',
    telechargementBusinessPlanPreview: 'Business Plan Preview',
    ...
    pourcentageCompletionBPUpdatedDansBackendApp: 'BP - Pourcentage Completion Update',
